...
User.create(username: 'PlayThis', password: 'playthis', email: 'playthis@playthis.com', avatar: "https://s3-us-west-1.amazonaws.com/playthismusic/images/logo-green.png")
...
User.create(username: 'chip', password: 'password', email: 'test7@test.com', avatar: "https://s3-us-west-1.amazonaws.com/playthismusic/images/fluffy.jpg")
...
Playlist.create(title: 'Coffee Shop', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-coffeeshop.jpeg")
Playlist.create(title: 'Cozy Up', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-cozy.jpeg")
Playlist.create(title: 'Dreamy', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-dreamy.jpeg")
Playlist.create(title: 'Have Fun', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-fun.jpeg")
Playlist.create(title: 'Out on the Town', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-outonthetown.jpeg")
Playlist.create(title: 'Grooves', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-grooves.jpeg")
Playlist.create(title: 'Holiday Music', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-holiday.jpeg")
Playlist.create(title: 'Jazz', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-jazz.jpeg")
Playlist.create(title: 'Keys', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-keys.jpeg")
Playlist.create(title: 'Live Music', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-live.jpeg")
Playlist.create(title: 'Night Out', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-nightout.jpeg")
Playlist.create(title: 'Road Trip', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-roadtrip.jpeg")
Playlist.create(title: 'Relax', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-relax.jpeg")
Playlist.create(title: 'Rock n Roll', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-rock.jpeg")
Playlist.create(title: 'Study', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-study.jpeg")
Playlist.create(title: 'Work Out', author_id: 1, image: "https://s3-us-west-1.amazonaws.com/playthismusic/music-images/p-workout.jpeg")
